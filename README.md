...
Then, configure the joystick to the driver using the applicationís GUI.  To use the joystick with this application, disable the ability to click using the joystick buttons, and enable the ability to control the mouse.
